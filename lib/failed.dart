...
class _HomeState extends State<Home> {
  ...
  Future<void> sendImage(XFile? imagefile) async {
    ...
    String apikey =
        "AIzaSyB6l71HXh3P6wtUEJZt7kWwLY8ZtY6aRao"; // Replace with your actual API key
    ...
    try {
      ...
      http.Response response = await http.post(
        Uri.parse(
            "https://generativelanguage.googleapis.com/v1beta/models/gemini-1.0-pro-vision:generateContent"),
        headers: {
